...
export default function PaymentPage() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            {/* A grid with 5 columns on md+ screens, 1 column on small screens */}
            <div className="grid grid-cols-1 md:grid-cols-5 gap-6">

                {/* Cart Items: spans 4 of 5 columns on md+ */}
                <div className="md:col-span-4 overflow-x-auto bg-white rounded-lg shadow-md p-6">
                ...
                {/* Order Summary: spans 1 of 5 columns on md+ */}
